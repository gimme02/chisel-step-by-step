file://<WORKSPACE>/src/main/scala/Config.scala
...
action parameters:
offset: 300
uri: file://<WORKSPACE>/src/main/scala/Config.scala
text:
```scala
...
object MainMemoryConfig {
    def apply() : MemoryConfig = {
        MemoryConfig (
            capacity = 8092
        )
    }
